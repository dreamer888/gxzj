...
public class AgentDeviceRelationEntity implements Serializable {
    private Long id;
    ...
    public AgentDeviceRelationEntity(Long id, Long agentId, Long opsId, String deviceNo, String deviceImei, Integer inventory, Integer status, String opsPhone, String addr, Integer freePaperTotal, Integer payPaperTotal, Integer gzhLikeTotal, Integer gzhIncomeSum, Integer payPaperSum, Integer commissionSum, Date createTime) {
        this.id = id;
    ...
    public AgentDeviceRelationEntity(Long agentId, String deviceNo, Integer freePaperTotal, Integer payPaperTotal, Integer gzhLikeTotal, Integer gzhIncomeSum, Integer payPaperSum, Integer commissionSum) {
        this.agentId = agentId;
        this.deviceNo = deviceNo;
        this.freePaperTotal = freePaperTotal;
        this.payPaperTotal = payPaperTotal;
    ...
    public AgentDeviceRelationEntity() {
        super();
    }
