...
public class GetBank {
    ...
    public static String getrealname(String cardnumber) {
...
public static void main(String[] args) {  
    String cardNum= "622908337674487210";
    if (checkBankCard(cardNum)){
        System.out.println("cardNum = " + getrealname(cardNum));
    }else {
        System.out.println("cardNum = cuow" );
    }
